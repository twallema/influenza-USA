...
n_thin = 10
multip_chains = 5
dataset_name = 'mobility_cellphone_09032020_states_longform.csv'
granularity_name = 'to_state_data'
...
data = pd.read_csv(os.path.join(os.getcwd(), f'../../interim/mobility/intermediates/{granularity_name}/{dataset_name}'), dtype={'origin': str, 'destination': str})
...
if __name__ == '__main__':
    ...
    plt.savefig(os.path.join(os.getcwd(), f'../../interim/mobility/fitted_models/{granularity_name}/departure_diffusion_power_gravitation/comparison.png'), dpi=200)
    plt.show()
    plt.close()
    ...
    matrix_counties.to_csv(os.path.join(os.getcwd(), f'../../interim/mobility/fitted_models/{granularity_name}/departure_diffusion_power_gravitation/matrix_counties.csv'), index=True)