...
library(readxl)
data_long <- read.csv("../interim/mobility/mobility_2011_2015-longform.csv", colClasses = c(origin = "character", destination = "character")) 
...
```{r fit}
modRad <- mobility(data=matrix_list, model='radiation', type='basic', DIC=TRUE, parallel=TRUE)
```
...
```{r save}
write.csv(M_hatRad, "../interim/mobility/matrix_radiation_2011_2015_counties.csv")
```
...
# save data
write.csv(matrix_df, "../interim/mobility/matrix_radiation_2011_2015_states.csv", row.names=FALSE)
```